(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jQuery"), require("JitsiMeetJS"), require("@medme/lib-jitsi-meet/JitsiConference"), require("@medme/lib-jitsi-meet/JitsiConnection"), require("@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack"), require("@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack"));
	else if(typeof define === 'function' && define.amd)
		define("App", ["jQuery", "JitsiMeetJS", "@medme/lib-jitsi-meet/JitsiConference", "@medme/lib-jitsi-meet/JitsiConnection", "@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack", "@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack"], factory);
	else if(typeof exports === 'object')
		exports["App"] = factory(require("jQuery"), require("JitsiMeetJS"), require("@medme/lib-jitsi-meet/JitsiConference"), require("@medme/lib-jitsi-meet/JitsiConnection"), require("@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack"), require("@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack"));
	else
		root["App"] = factory(root["jQuery"], root["JitsiMeetJS"], root["@medme/lib-jitsi-meet/JitsiConference"], root["@medme/lib-jitsi-meet/JitsiConnection"], root["@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack"], root["@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_jquery__, __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet__, __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_JitsiConference__, __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_JitsiConnection__, __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_modules_RTC_JitsiLocalTrack__, __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_modules_RTC_JitsiRemoteTrack__) {
return /******/ (() => { // webpackBootstrap
/******/ 	var __webpack_modules__ = ({

/***/ "../../medme/3dparts/jitsi-meet.js":
/*!*****************************************!*\
  !*** ../../medme/3dparts/jitsi-meet.js ***!
  \*****************************************/
/***/ ((module) => {
    ...
    , function(e, t, n) {
        ...
        class s extends i.a {
            constructor(...e) {
                ...
                super(...e),
                r = {},
                (n = "_storage")in (t = this) ? Object.defineProperty(t, n, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
        ...
        class o extends i.a {
            constructor() {
                ...
                this._storage || (console.warn("Local storage is disabled."),
                this._storage = new s,
        ...
        function h(e) {
            ...
            r) {
                ...
                e = e.substring(n.lastIndex);
                const s = i.indexOf("@");
                -1 !== s && (i = i.substring(s + 1)),
                t.host = i;
                const o = i.lastIndexOf(":");
                -1 !== o && (t.port = i.substring(o + 1),
                i = i.substring(0, o)),
                t.hostname = i
            }
            if (n = new RegExp("^([^?#]*)","gi"),
        ...
        function p(e) {
            ...
            if (!n.host) {
                ...
                if (t) {
                    const {host: e, hostname: i, pathname: s, port: o} = h(l("org.jitsi.meet://" + t));
                    e && (n.host = e,
                    n.hostname = i,
                    n.port = o),
                    "/" === r && "/" !== s && (r = s)
            ...
            if (s) {
                let {search: e} = n;
                -1 === e.indexOf("?jwt=") && -1 === e.indexOf("&jwt=") && (e.startsWith("?") || (e = "?" + e),
                1 === e.length || (e += "&"),
                e += "jwt=" + s,
                n.search = e)
            }
        ...
        class _ {
            ...
            _onMessageReceived(e) {
                if ("response" === e.type) {
                    ...
                    "request" === e.type ? this.emit("request", e.data, (t,n)=>{
                        this._backend.send({
                            type: "response",
                            error: n,
                            id: e.id,
        ...
        window.JitsiMeetJS.app).setExternalTransportBackend = e=>L.setBackend(e);
        var O = n(4)
          , x = n(0);
        function j(e, t) {
            if (null == e)
        ...
        class D extends i.a {
            constructor(e, ...t) {
                super();
                const {roomName: n="", width: r="100%", height: i="100%", parentNode: s=document.body, configOverwrite: o={}, interfaceConfigOverwrite: c={}, noSSL: l=!1, jwt: u, onload: h, invitees: d, devices: p, userInfo: f, e2eeKey: g} = function(e) {
                    if (!e.length)
                        return {};
                    switch (typeof e[0]) {
                    case "string":
            ...
            _setupListeners() {
                this._transport.on("event", e=>{
                    ...
                    case "video-conference-joined":
                        void 0 !== this._tmpE2EEKey && (this.executeCommand(C.e2eeKey, this._tmpE2EEKey),
                    ...
                    case "participant-joined":
                        ...
                        this._participants[r].formattedDisplayName = n.formattedDisplayName,
                        R(this, 1);
                        break;
                    case "participant-left":
                        R(this, -1),
                        delete this._participants[r];
                        break;
                    case "display-name-change":
                        {
                            const e = this._participants[r];
                            e && (e.displayName = n.displayname,
...
"use strict";
module.exports = JSON.parse('{"formatFull":"dd. DD MMM YYYY, H:mm","formatTimeShort":"HH:mm","formatDurationAbbrev":["d","h","min","sec"]}');

/***/ }),

/***/ "../../medme/lang/date-time-he.json":
/*!******************************************!*\
  !*** ../../medme/lang/date-time-he.json ***!
  \******************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"formatFull":"dd. DD MMM YYYY, H:mm","formatTimeShort":"HH:mm","formatDurationAbbrev":["יום","שעה","דק\'","שנ\'"]}');

/***/ }),

/***/ "../../medme/lang/date-time-ru.json":
/*!******************************************!*\
  !*** ../../medme/lang/date-time-ru.json ***!
  \******************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"formatFull":"dd. DD MMM YYYY, H:mm","formatTimeShort":"HH:mm","formatDurationAbbrev":["д","ч","мин","сек"]}');

/***/ }),

/***/ "../../medme/lang/en-en.json":
/*!***********************************!*\
  !*** ../../medme/lang/en-en.json ***!
  \***********************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"401":{"title":"access denied"},"404":{"title":"not found"},"document_title_prefix":"MedMe Meets | ","conference_preload_text":"please wait...","specialist":"specialist","specialists":"specialists","services":"services","service":"service","clients":"clients","client":"client","guest":"Guest","help_link":"Help","common":{"title":"Doctor\'s appointments online","remained_duration":"remained","real_start":"start time","real_end":"end time"},"pending_client":{"title":"The meeting hasn\'t started yet","hint1":"We will send you an invitation 10 minutes before the reception starts","hint2":"Please stay in touch at this time.","conf_info_link":"information about meeting"},"pending_specialist":{"title":"The meeting hasn\'t started yet","button":"Invite a client to an appointment","button_open":"Open meet","cancel_button":"Cancel the appointment","hint1":"Participants of the video conference will be able to log in to it","hint2":"If you or a client can\'t make an appointment, you can cancel it","conf_info_link":"information about meeting"},"join_client":{"title":"Join a video conference","button":"Go to the reception","hint":"Click to start an appointment with your specialist","conf_info_link":"information about meeting"},"join_specialist":{"title":"Join a video conference","button":"Join to the meeting","hint":"Click to start a meeting with a client","conf_info_link":"information about meeting"},"conference_info_block":{"title":"Information about this conference","scheduled_start":"scheduled start time","scheduled_duration":"scheduled duration","real_duration":"duration","specialist":"specialist","specialists":"specialists","services":"services","service":"service","clients":"clients","client":"client","cancelled_during_several_minutes":"The meeting will be completed automatically in the next few minutes","finish_button":"Finish","leave_meet":"Leave"},"finish_screen":{"title":"Meeting is already complete","hint1":"You can restore meeting within 3 minutes by clicking the button","restore_button":"To resume receiving","conf_info_link":"information about meeting"},"pause_block":{"title":"Meeting on pause"},"cancelled_screen":{"title":"Meeting canceled","client_hint0":"Your specialist may not be able to see you at this time. ","client_hint1":"You can make an appointment online for a different time or with a different specialist.","hint1":"You can restore meeting within 3 minutes by clicking the button","restore_button":"Resume meeting","conf_info_link":"information about meeting"}}');

/***/ }),

/***/ "../../medme/lang/en-medicine.json":
/*!*****************************************!*\
  !*** ../../medme/lang/en-medicine.json ***!
  \*****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"401":{"title":"access denied"},"404":{"title":"not found"},"document_title_prefix":"MedMe Meets | ","conference_preload_text":"please wait...","specialist":"doctor","specialists":"doctors","services":"services","service":"service","clients":"patients","client":"patient","guest":"Guest","help_link":"Help","common":{"title":"Doctor\'s appointments online","remained_duration":"remained","real_start":"start time","real_end":"end time"},"pending_client":{"title":"The meeting hasn\'t started yet","hint1":"We will send you an invitation 10 minutes before the reception starts","hint2":"Please stay in touch at this time.","conf_info_link":"information about meeting"},"pending_specialist":{"title":"The meeting hasn\'t started yet","button":"Invite a patient to an appointment","button_open":"Open meet","cancel_button":"Cancel the appointment","hint1":"Participants of the video conference will be able to log in to it","hint2":"If you or a client can\'t make an appointment, you can cancel it","conf_info_link":"information about meeting"},"join_client":{"title":"Join a video conference","button":"Go to the reception","hint":"Click to start an appointment with your doctor","conf_info_link":"information about meeting"},"join_specialist":{"title":"Join a video conference","button":"Join to the meeting","hint":"Click to start a meeting with a patient","conf_info_link":"information about meeting"},"conference_info_block":{"title":"Information about this conference","scheduled_start":"scheduled start time","scheduled_duration":"scheduled duration","real_duration":"duration","specialist":"doctor","specialists":"doctors","services":"services","service":"service","clients":"patients","client":"patient","cancelled_during_several_minutes":"The meeting will be completed automatically in the next few minutes","finish_button":"Finish","leave_meet":"Leave"},"finish_screen":{"title":"Meeting is already complete","hint1":"You can restore meeting within 3 minutes by clicking the button","restore_button":"To resume receiving","conf_info_link":"information about meeting"},"pause_block":{"title":"Meeting on pause"},"cancelled_screen":{"title":"Meeting canceled","client_hint0":"Your doctor may not be able to see you at this time. ","client_hint1":"You can make an appointment online for a different time or with a different specialist.","hint1":"You can restore meeting within 3 minutes by clicking the button","restore_button":"Resume meeting","conf_info_link":"information about meeting"}}');

/***/ }),

/***/ "../../medme/lang/he-he.json":
/*!***********************************!*\
  !*** ../../medme/lang/he-he.json ***!
  \***********************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"401":{"title":"אין גישה"},"404":{"title":"המפגש לא נמצא"},"document_title_prefix":"MedMe Meets | ","conference_preload_text":"הפגישה בטעינה...","specialist":"מטפל","specialists":"מטפלים","services":"שרותים","service":"שרות","clients":"מטופלים","client":"מטופל","guest":"אורח","help_link":"Help","common":{"title":"MedMe Meets","remained_duration":"עד סוף המפגש נשאר","real_start":"זמן התחלה","real_end":"זמן סיום"},"pending_client":{"title":"הפגישה טרם התחילה","hint1":"תקבלו לינק למפגש 10 דק\' לפני תחילתו","hint2":"אנא תהיו זמינים","conf_info_link":"מידע על המפגש"},"pending_specialist":{"title":"הפגישה טרם התחילה","button":"להזמין מטופל למפגש","button_open":"לפתוח פגישה","cancel_button":"לבטל פגישה","hint1":"למשתתפי המפגש תהיה אפשרות להתחבר","hint2":"אם המטופל לא מצליח להתחבר ניתן לבטל את הפגישה","conf_info_link":"מידע על המפגש"},"join_client":{"title":"להתחבר לפגישה","button":"להיכנס לפגישה","hint":"נא ללחוץ על מנת להתחיל","conf_info_link":"מידע על המפגש"},"join_specialist":{"title":"להתחבר לפגישה","button":"להיכנס לפגישה","hint":"נא ללחוץ על מנת להתחיל","conf_info_link":"מידע על המפגש"},"conference_info_block":{"title":"מידע על המפגש","scheduled_start":"זמן התחלה מתוכנן","scheduled_duration":"זמן סיום מתוכנן","real_duration":"משך הפגיזה","specialist":"מטפל","specialists":"מטפלים","services":"שרותים","service":"שרות","clients":"מטופלים","client":"מטופל","cancelled_during_several_minutes":"הפגישה תסתיים בעוד כמה דקות","finish_button":"לסיים","leave_meet":"לעזוב את הפגיזה"},"finish_screen":{"title":"הפגישה הסתיימה","hint1":"אתם יכולים להתחבר לפגישה שנית במשך 3 דקות הקרובות על ידי לחיצה על כפתור","restore_button":"לחדש פגישה","conf_info_link":"מידע על הפגישה"},"pause_block":{"title":"הפגישה מעצרה"},"cancelled_screen":{"title":"הפגישה בוטלה","client_hint0":"כנראה המטפל לא יכול לקבל אתכם כעת ","client_hint1":"ניתן להירשם לזמן אחר","hint1":" אתם יכולים להתחבר לפגישה שנית במשך 3 דקות הקרובות על ידי לחיצה על כפתור ","restore_button":"לחדש פגישה","conf_info_link":"מידע על המפגש"}}');

/***/ }),

/***/ "../../medme/lang/he-medicine.json":
/*!*****************************************!*\
  !*** ../../medme/lang/he-medicine.json ***!
  \*****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"list":[{"key":"ru-ru","alias":"Ru"},{"key":"en-en","alias":"En"},{"key":"he-he","alias":"He"}]}');

/***/ }),

/***/ "../../medme/lang/ru-medicine.json":
/*!*****************************************!*\
  !*** ../../medme/lang/ru-medicine.json ***!
  \*****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"401":{"title":"Нет доступа"},"404":{"title":"Приём не найден"},"document_title_prefix":"MedMe Meets | ","conference_preload_text":"идет подготовка...","specialist":"врач","specialists":"врачи","services":"услуги","service":"услуга","clients":"пациенты","client":"пациент","guest":"Гость","help_link":"Помощь","common":{"title":"MedMe Meets","remained_duration":"осталось времени","real_start":"время начала","real_end":"время окончания"},"pending_client":{"title":"Приём ещё не начат","hint1":"Мы вышлем вам приглашение за 10 минут до начала приёма.","hint2":"Пожалуйста, будьте на связи в этот момент.","conf_info_link":"информация о приёме"},"pending_specialist":{"title":"Приём ещё не начат","button":"Пригласить пациента на приём","button_open":"Открыть приём","cancel_button":"Отменить приём","hint1":"Участники видеоконференции получат возможность зайти на неё","hint2":"Если у вас или клиента не получается прийти на приём, вы можете отменить его","conf_info_link":"информация о приёме"},"join_client":{"title":"Присоединиться к видеоконференции","button":"Зайти на приём","hint":"Нажмите, чтобы начать встречу с врачом","conf_info_link":"информация о приёме"},"join_specialist":{"title":"Присоединиться к видеоконференции","button":"Зайти на приём","hint":"Нажмите, чтобы начать встречу с пациентом","conf_info_link":"информация о приёме"},"conference_info_block":{"title":"Информация о приёме","scheduled_start":"запланированное время начала","scheduled_duration":"запланированная длительность","real_duration":"длительность","specialist":"врач","specialists":"врачи","services":"услуги","service":"услуга","clients":"пациенты","client":"пациент","cancelled_during_several_minutes":"Встреча будет завершена автоматически в ближайшие несколько минут","finish_button":"Завершить","leave_meet":"Покинуть приём"},"finish_screen":{"title":"Приём завершён","hint1":"Вы можете восстановить приём в течение 3-x минут, нажав по кнопке","restore_button":"Восстановить приём","conf_info_link":"информация о приёме"},"pause_block":{"title":"Приём на паузе"},"cancelled_screen":{"title":"Приём отменён","client_hint0":"Вероятно врач не может вас принять в это время. ","client_hint1":"Вы можете записаться онлайн на другое время или к другому специалисту.","hint1":"Вы можете восстановить приём в течение 3-x минут, нажав по кнопке","restore_button":"Восстановить приём","conf_info_link":"информация о приёме"}}');

/***/ }),

/***/ "../../medme/lang/ru-ru.json":
/*!***********************************!*\
  !*** ../../medme/lang/ru-ru.json ***!
  \***********************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"401":{"title":"нет доступа"},"404":{"title":"приём не найден"},"document_title_prefix":"MedMe Meets | ","conference_preload_text":"идет подготовка...","specialist":"специалист","specialists":"специалисты","services":"услуги","service":"услуга","clients":"клиенты","client":"клиент","guest":"Гость","help_link":"Помощь","common":{"title":"Приём к специалисту онлайн","remained_duration":"осталось времени","real_start":"время начала","real_end":"время окончания"},"pending_client":{"title":"Приём ещё не начат","hint1":"Мы вышлем вам приглашение за 10 минут до начала приёма.","hint2":"Пожалуйста, будьте на связи в этот момент.","conf_info_link":"информация о приёме"},"pending_specialist":{"title":"Приём ещё не начат","button":"Пригласить клиента на приём","button_open":"Открыть приём","cancel_button":"Отменить приём","hint1":"Участники видеоконференции получат возможность зайти на неё","hint2":"Если у вас или клиента не получается прийти на приём, вы можете отменить его","conf_info_link":"информация о приёме"},"join_client":{"title":"Присоединиться к видеоконференции","button":"Зайти на приём","hint":"Нажмите, чтобы начать встречу со специалистом","conf_info_link":"информация о приёме"},"join_specialist":{"title":"Присоединиться к видеоконференции","button":"Зайти на приём","hint":"Нажмите, чтобы начать встречу с пациентом","conf_info_link":"информация о приёме"},"conference_info_block":{"title":"Информация о приёме","scheduled_start":"запланированное время начала","scheduled_duration":"запланированная длительность","real_duration":"длительность","specialist":"специалист","specialists":"специалисты","services":"услуги","service":"услуга","clients":"клиенты","client":"клиент","cancelled_during_several_minutes":"Встреча будет завершена автоматически в ближайшие несколько минут","finish_button":"Завершить","leave_meet":"Покинуть приём"},"finish_screen":{"title":"Приём завершён","hint1":"Вы можете восстановить приём в течение 3-x минут, нажав по кнопке","restore_button":"Восстановить приём","conf_info_link":"информация о приёме"},"pause_block":{"title":"Приём на паузе"},"cancelled_screen":{"title":"Приём отменён","client_hint0":"Вероятно врач не может вас принять в это время. ","client_hint1":"Вы можете записаться онлайн на другое время или к другому специалисту.","hint1":"Вы можете восстановить приём в течение 3-x минут, нажав по кнопке","restore_button":"Восстановить приём","conf_info_link":"информация о приёме"}}');
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! ../../../index */ "../../index.ts"), __webpack_require__(/*! ./conf */ "./src/conf.ts"), __webpack_require__(/*! moment */ "../../node_modules/moment/moment.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, jquery_1, mmconf, conf_1, moment_1) {
    "use strict";
    ...
    var _renderConferenceInfo = function (confInfo, text, l, timer, opts) {
        ...
        conferenceInfo.scheduledStartFormatFull = moment_1.default(conferenceInfo.scheduledStart)
            .format(text.dateTime.formatFull);
        if (conferenceInfo.startedAt) {
            conferenceInfo.realStartFormatShort = moment_1.default(conferenceInfo.startedAt)
                .format(text.dateTime.formatTimeShort);
            conferenceInfo.realStartFormatFull = moment_1.default(conferenceInfo.startedAt)
                .format(text.dateTime.formatFull);
        }
        if (timer) {
            conferenceInfo.scheduledEndFormatShort = moment_1.default(timer.expectedEndAt)
                .format(text.dateTime.formatTimeShort);
        }
        if (opts.showRealTimes && timer) {
            conferenceInfo.realEndFormatFull = moment_1.default(conferenceInfo.finishedAt)
                .format(text.dateTime.formatFull);
        ...
        confInfo.services.forEach(function (s) {
            jquery_1.default('#conf_info__services')
        ...
        confInfo.specialists.forEach(function (s) {
            jquery_1.default('#conf_info__specialists')
        ...
        confInfo.clients.forEach(function (s) {
            jquery_1.default('#conf_info__clients')
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! ../../../index */ "../../index.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, jquery_1, index_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
    exports.openConference = void 0;
    jquery_1 = __importDefault(jquery_1);
    var JitsiMeetJS = index_1.JML.JitsiMeetJS;
    var ConferenceEvents = index_1.JML.ConferenceEvents;
    var ConferenceConfig = index_1.JML.ConferenceConfig;
    var createConference = index_1.JML.createConferenceAndConnect;
    function openConference() {
        // The name of client node advertised in XEP-0115 'c' stanza
        var CLIENT_NODE = location.host + ":" + location.port; // "localhost:4000"
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./medme/lib/index */ "../../medme/lib/index.ts"), __webpack_require__(/*! ./medme/env */ "../../medme/env.ts"), __webpack_require__(/*! ./medme/lib/httpRequest */ "../../medme/lib/httpRequest.ts"), __webpack_require__(/*! ./medme/lib/statuses */ "../../medme/lib/statuses.ts"), __webpack_require__(/*! ./medme/lib/types/index */ "../../medme/lib/types/index.ts"), __webpack_require__(/*! ./medme/lib/sock */ "../../medme/lib/sock.ts"), __webpack_require__(/*! ./medme/lib/ux */ "../../medme/lib/ux.ts"), __webpack_require__(/*! ./medme/lib/jmlib */ "../../medme/lib/jmlib.ts"), __webpack_require__(/*! ./medme/lib/sock */ "../../medme/lib/sock.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, lib, env, request, statuses, types, sock, UX, JML, sock_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./date-time-en.json */ "../../medme/lang/date-time-en.json"), __webpack_require__(/*! ./en-en.json */ "../../medme/lang/en-en.json"), __webpack_require__(/*! ./en-medicine.json */ "../../medme/lang/en-medicine.json"), __webpack_require__(/*! ./date-time-he.json */ "../../medme/lang/date-time-he.json"), __webpack_require__(/*! ./he-he.json */ "../../medme/lang/he-he.json"), __webpack_require__(/*! ./he-medicine.json */ "../../medme/lang/he-medicine.json"), __webpack_require__(/*! ./date-time-ru.json */ "../../medme/lang/date-time-ru.json"), __webpack_require__(/*! ./ru-ru.json */ "../../medme/lang/ru-ru.json"), __webpack_require__(/*! ./ru-medicine.json */ "../../medme/lang/ru-medicine.json"), __webpack_require__(/*! ./lang-list.json */ "../../medme/lang/lang-list.json")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, date_time_en_json_1, en_en_json_1, en_medicine_json_1, date_time_he_json_1, he_he_json_1, he_medicine_json_1, date_time_ru_json_1, ru_ru_json_1, ru_medicine_json_1, lang_list_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
    exports.l10n = void 0;
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! cross-fetch */ "../../node_modules/cross-fetch/dist/browser-ponyfill.js"), __webpack_require__(/*! ./statuses */ "../../medme/lib/statuses.ts"), __webpack_require__(/*! ../env */ "../../medme/env.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, cross_fetch_1, statuses_1, env_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./httpRequest */ "../../medme/lib/httpRequest.ts"), __webpack_require__(/*! ./time */ "../../medme/lib/time.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, httpRequest_1, time_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @medme/lib-jitsi-meet */ "@medme/lib-jitsi-meet"), __webpack_require__(/*! @medme/lib-jitsi-meet/JitsiConference */ "@medme/lib-jitsi-meet/JitsiConference"), __webpack_require__(/*! @medme/lib-jitsi-meet/JitsiConnection */ "@medme/lib-jitsi-meet/JitsiConnection"), __webpack_require__(/*! @medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack */ "@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack"), __webpack_require__(/*! @medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack */ "@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack"), __webpack_require__(/*! ../env */ "../../medme/env.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, lib_jitsi_meet_1, JitsiConference_1, JitsiConnection_1, JitsiLocalTrack_1, JitsiRemoteTrack_1, defaultEnv) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
    ...
    var ConferenceSession = /** @class */ (function () {
    ...
    var ConferenceConfig = /** @class */ (function () {
    ...
    var ConferenceCtl = /** @class */ (function () {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./conference */ "../../medme/lib/types/conference.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, conference) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! ./types/conference */ "../../medme/lib/types/conference.ts"), __webpack_require__(/*! ./httpRequest */ "../../medme/lib/httpRequest.ts"), __webpack_require__(/*! ./statuses */ "../../medme/lib/statuses.ts"), __webpack_require__(/*! ../lang/index */ "../../medme/lang/index.ts"), __webpack_require__(/*! ../env */ "../../medme/env.ts"), __webpack_require__(/*! moment */ "../../node_modules/moment/moment.js"), __webpack_require__(/*! ../3dparts/jitsi-meet */ "../../medme/3dparts/jitsi-meet.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, conference_1, httpRequest_1, statuses_1, index_1, env, moment_1, jitsi_meet_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", ({ value: true }));
...
/***/ "@medme/lib-jitsi-meet/JitsiConference":
/*!********************************************************!*\
  !*** external "@medme/lib-jitsi-meet/JitsiConference" ***!
  \********************************************************/
/***/ ((module) => {

"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_JitsiConference__;

/***/ }),

/***/ "@medme/lib-jitsi-meet/JitsiConnection":
/*!********************************************************!*\
  !*** external "@medme/lib-jitsi-meet/JitsiConnection" ***!
  \********************************************************/
/***/ ((module) => {

"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_JitsiConnection__;

/***/ }),

/***/ "@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack":
/*!********************************************************************!*\
  !*** external "@medme/lib-jitsi-meet/modules/RTC/JitsiLocalTrack" ***!
  \********************************************************************/
/***/ ((module) => {

"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_modules_RTC_JitsiLocalTrack__;

/***/ }),

/***/ "@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack":
/*!*********************************************************************!*\
  !*** external "@medme/lib-jitsi-meet/modules/RTC/JitsiRemoteTrack" ***!
  \*********************************************************************/
/***/ ((module) => {

"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet_modules_RTC_JitsiRemoteTrack__;

/***/ }),

/***/ "@medme/lib-jitsi-meet":
/*!******************************!*\
  !*** external "JitsiMeetJS" ***!
  \******************************/
/***/ ((module) => {

"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__medme_lib_jitsi_meet__;
...
/******/ 	__webpack_exports__ = __webpack_exports__.App;
/******/ 	
